...
- **No implementation details in the README** — scoring tables, algorithms or "how we figured it
  out" stories go to `docs/internals.md`.
...
- Prefix with a scope, e.g. `feat(planner): …`, `fix(scoring): …`, `docs(repo): …`,
  `chore(repo): …`.
